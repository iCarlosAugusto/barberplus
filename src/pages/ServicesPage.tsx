...
const ServicesPage: React.FC = () => {
  ...
  if (error) {
    return <div className="error-message bg-red-100 p-4 rounded text-red-700">{error}</div>;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <header className="mb-8">
        ...
        <p className="text-gray-600">Rua 238, QD40 lt 16 n 392, 74603-180, Goiânia</p>
      </header>
      ...
      <div className="mt-12 border-t pt-8">
        <h2 className="text-2xl font-bold mb-6 border-b pb-2">Localização e Contato</h2>
          ...
          <div>
            <div className="space-y-3">
              <p className="flex items-center">
                ...
                <span>Rua 238, QD40 lt 16 n 392, 74603-180, Goiânia</span>
              </p>
              <p className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="flex items-center">
                ...
                <span>contato@coloradobarbearia.com.br</span>
              </p>
              <p className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <div className="w-full h-80 bg-blue-500 rounded-lg shadow-md flex items-center justify-center">
              <div className="text-white text-center">
                ...
                <p className="font-semibold">Colorado Barbearia</p>
                <p className="text-sm">Mapa interativo indisponível</p>
              </div>
            </div>
            <div className="mt-4">
              <p className="text-sm">Estamos localizados no coração de Goiânia, com fácil acesso e estacionamento próximo.</p>
              <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="inline-block mt-2 text-blue-600 hover:text-blue-800 font-medium">
                Ver no Google Maps →
              </a>
            </div>
          </div>
      ...
      {/* Booking Modal */}
        ...
        <BeautyModal isOpen={showModal} onClose={() => setShowModal(false)} title={""}>
          <>
            <BeautyDatePicker />
